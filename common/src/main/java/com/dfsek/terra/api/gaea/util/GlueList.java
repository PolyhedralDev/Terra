...
public class GlueList<T> extends AbstractList<T> implements List<T>, Cloneable, Serializable {
    ...
    private class Itr implements Iterator<T> {
        ...
        public void remove() {
            ...
            try {
                com.dfsek.terra.api.gaea.util.GlueList.this.remove(lastReturn);
    ...
    private class ListItr extends Itr implements ListIterator<T> {
        ...
        public void set(T t) {
            ...
            try {
                com.dfsek.terra.api.gaea.util.GlueList.this.set(lastReturn, t);
            } catch (IndexOutOfBoundsException e) {
                throw new ConcurrentModificationException();
            }
        }
        ...
        public void add(T t) {
            ...
            try {
                ...
                com.dfsek.terra.api.gaea.util.GlueList.this.add(temp, t);
